...
export default function OrdersTab() {
  ...
  const [orderToMarkDelivered, setOrderToMarkDelivered] =
  ...
  const handleMarkDelivered = (orderId: number, pricePaid: number) => {
    const updatedOrders: Order[] = orders.map((order) =>
      order.id === orderId
        ? { ...order, status: "Fullfilled", pricePaid, updatedAt: new Date() }
        : order
    );
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                        {order.status === "Pending" && (
                          <Dialog
                            open={
                              isDeliveredDialogOpen &&
                              orderToMarkDelivered?.id === order.id
                            }
                            onOpenChange={(open) => {
                              ...
                              <div className="grid gap-4 py-4">
                                <div className="grid grid-cols-4 items-center gap-4">
                                  ...
                                  <Input
                                    ...
                                    step="0.01"
                                    defaultValue={
                                      orderToMarkDelivered?.pricePaid || ""
                                    }
                        ...
                        <Dialog
                          open={
                            isEditDialogOpen && currentOrder?.id === order.id
                          }
                          onOpenChange={(open) => {
                        ...
                        >
                          ...
                          <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Make changes to the order. Click save when
                                you're done.
                              </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-4 py-4">
