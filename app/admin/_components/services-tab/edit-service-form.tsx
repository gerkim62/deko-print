...
export function EditServiceForm({ service, onSuccess, setCanClose }: Props) {
  ...
  const [formData, setFormData] = useState<Partial<z.infer<typeof NewServiceSchema>>>({
    title: "",
    description: "",
    category: "Printing",
    startingPrice: 0,
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      const shouldUploadImage = imagePreview && file && imagePreview !== service.image
      ...
      if (shouldUploadImage) {
        ...
        const { message: imgMsg, success: imgSuccess } = getReadableActionResult(uploadResult)
  ...
  return (
    <DialogContent className="sm:max-w-[525px]">
      <DialogHeader>
        ...
        <DialogDescription className="text-sm">Make changes to the service.</DialogDescription>
      </DialogHeader>
      <div className="grid gap-2 py-2">
        ...
        <div className="grid grid-cols-4 items-start gap-2">
          ...
          <div className="col-span-3">
            ...
            >
              {imagePreview ? (
                <img src={imagePreview || "/placeholder.svg"} alt="Service preview" className="h-full object-contain" />
              ) : (
